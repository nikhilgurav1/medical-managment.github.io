...
<head>
  ...
  <title>
  Medical Management System - Manage Medicine
  </title>
  <!-- Favicon -->
...
?>              
              ...
              <input type="text" id="compname" name="compname" class="form-control form-control-alternative" value="<?php  echo $row['MedicineCompany'];?>" required="true">
                      </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="medname" name="medname"  class="form-control form-control-alternative" value="<?php  echo $row['MedicineName'];?>" required="true">
                      </div>
                    </div>
                     <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Medicine Batch Number</label>
                        <input type="text" id="batchnumber" name="batchnumber" class="form-control form-control-alternative" value="<?php  echo $row['MedicineBatchno'];?>" required="true">
                      </div>
                    </div>
                     ...
                     <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="date" id="mgfdate" name="mgfdate" class="form-control form-control-alternative" value="<?php  echo $row['MgfDate'];?>" required="true" >
                      </div>
                    </div>
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Expiry Date</label>
                        <input type="date" id="expirydate" name="expirydate" class="form-control form-control-alternative" value="<?php  echo $row['ExpiryDate'];?>" required="true">
                      </div>
                    </div>
                  <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Quantity</label>
                        <input type="text" id="quantity" name="quantity" class="form-control form-control-alternative" value="<?php  echo $row['Quantity'];?>" required="true">
                      </div>
                    </div>
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Price per Unit</label>
                        <input type="text" id="price" name="price" class="form-control form-control-alternative" value="<?php  echo $row['Priceperunit'];?>" required="true">
                      </div>
                    </div>
                  </div>
                  <div class="row">
