...
<head>
  ...
  <title>
  Medical Management System - Pharmacist Dashboard
  </title>
...
//Last Sevendays Sale
 ...
 from tblcart 
  join tblmedicine  on tblmedicine.ID=tblcart.ProductId where date(CartDate)>=(DATE(NOW()) - INTERVAL 7 DAY) and tblcart.PharmacistId='$phid'");
...
$tseven+=$sevendays_sale;
 ...
 ?>
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0"><a href="pharmacist-report-ds.php">Last Sevendays Sale</a>  </h5>
